...
def eval_parameter(train_data, validation_data):
    ...
    my_metrics = [
        train_evaluation_model(train_data, validation_data, num_iterations, step_size, mini_batch_fraction)
        for num_iterations in num_iterations_list
        for step_size in step_size_list
        for mini_batch_fraction in mini_batch_fraction_list
    ]
...
def draw_graph(train_data, validation_data, eval_parm):
    ...
    elif eval_parm == "miniBatchFraction":
        index_list = mini_batch_fraction_list
        num_iterations_list = [15]
        step_size_list = [10]
    my_metrics = [
        train_evaluation_model(train_data, validation_data, num_iterations, step_size, mini_batch_fraction)
